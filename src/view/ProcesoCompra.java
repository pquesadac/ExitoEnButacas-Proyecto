/**
 * Ventana que muestra el estado de los usuarios durante la simulación concurrente.
 * Representa los diferentes estados de los usuarios mediante colores:
 * - Verde: Usuario sin acción (no está comprando).
 * - Naranja: Usuario intentando comprar asientos.
 * - Rojo: Usuario que ha completado la compra.
 * - Morado: Usuario que no pudo completar la compra después de múltiples intentos.
 */
